...
# === LOAD EXCEL FILE ===
file_path = r"C:\Users\nila2\OneDrive - University Of Oregon\Rubiya PhD All\COMSOL Design\Experiments\TRY\tip.xlsx"
...
plt.savefig("3D_ShortWidetip_Figure7a.png",
            dpi=1000,
            format='png',
            bbox_inches='tight',
            transparent=False)
plt.savefig("3D_ShortWidetip_Figure7a.pdf",
            dpi=1000,
            format='pdf',
            bbox_inches='tight',
            transparent=False)
